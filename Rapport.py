...
with st.container(border = True):
    ...
    st.image('/Users/chaimanemir/Desktop/detection_pytorch/hate-speech-detect-pytorch/st_/pages/classes.png')
with st.container(border = True):
    ...
    st.image('/Users/chaimanemir/Desktop/detection_pytorch/hate-speech-detect-pytorch/st_/pages/architecture.png')
    st.write('versions: ')
...
with st.container(border = True):
     ...
     st.image("/Users/chaimanemir/Desktop/detection_pytorch/hate-speech-detect-pytorch/st_/pages/lammagaurd.png")
     st.write('versions: ')
     st.write('- Transformers : 4.40.0')
     st.write("- Torch : 2.2.1+cu121")
