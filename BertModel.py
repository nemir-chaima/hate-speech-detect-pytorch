...
model.load_state_dict(torch.load('/Users/chaimanemir/Desktop/detection_pytorch/hate-speech-detect-pytorch/st_/pages/modele_pl.pt', map_location=torch.device('cpu')))
model.eval()
